...
<html>
  <head>
    ...
    <meta name="Generator" content="bconf2html.pl v0.4" />
...
<TMPL_VAR NAME="BCONFSTATS">
    ...
    <hr>
      ...
      &bull; <strong>Updated &raquo;</strong>&nbsp;&nbsp;<TMPL_VAR NAME="HOURS">:<TMPL_VAR NAME="MINS">&nbsp;<TMPL_VAR NAME="MON">/<TMPL_VAR NAME="DAY">/<TMPL_VAR NAME="YEAR">
