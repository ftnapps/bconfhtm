#!/usr/bin/perl
#  bconfhtm.pl v0.1  Copyright (c) 2006 Robert James Clay 
...
############################################
sub DisplayHelp {
    print "\nUsage:  bconfhtml.pl [-t Template] [-o HTMLDir] [-s StatsFile] / \n";
    print "                       [-f HTMLFileName] [-l LogFile] [-x] [-h]\n\n";
    print "   -t   Template file;  defaults to /opt/bbbs/work/bcnfhtml.tpl. \n";
    ...
    print "   -l   Path & filename of logfile; (/opt/bbbs/logs/wwwadm.log)\n";
    print "   -x   Debug Mode\n";
    print "   -h   This Help\n";
    print "\n";
}
